...
contract DateTime {
    ...
    function getTotalMinute(uint256 timestamp) public pure returns (uint256) {
        return uint256((timestamp / 60));
    }

    function getTotalHours(uint256 timestamp) public pure returns (uint64) {
        return uint64((timestamp / 60 / 60));
    }

    function getTotalDays(uint256 timestamp) public pure returns (uint64) {
